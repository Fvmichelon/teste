                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="services-one__top-text-box">
                            <p class="services-one__top-text">There are many variations of passages of Lorem Ipsum
                    ...
                    <div class="col-xl-12">
                        <ul class="list-unstyled services-one__list">
                            <li class="services-one__single wow fadeInUp" data-wow-delay="100ms">
                                ...
                                <h3 class="services-one__title"><a href="website-development.html">Ui / Ux <br>
                                        Creative
                                        design</a></h3>
                            ...
                            <li class="services-one__single wow fadeInUp" data-wow-delay="200ms">
                                ...
                                <div class="services-one__count"></div>
                                <h3 class="services-one__title"><a href="graphic-design.html">Visual <br> graphic
                                        design</a></h3>
                            ...
                            <li class="services-one__single wow fadeInUp" data-wow-delay="300ms">
                                ...
                                <div class="services-one__count"></div>
                                <h3 class="services-one__title"><a href="digital-marketing.html">strategy & <br>
                            ...
                            <li class="services-one__single wow fadeInUp" data-wow-delay="400ms">
                                ...
                                <div class="services-one__count"></div>
                                <h3 class="services-one__title"><a href="social-marketing.html">effective <br>
                ...
                <div class="col-xl-6">
                    <div class="get-to-know__right">
                        ...
                        <p class="get-to-know__text-1">We’re committed to delivering the best digital marketing for
                            your businesses</p>
                        <p class="get-to-know__text-2">There are many variations of passages of Lorem Ipsum
                            ...
                            <div class="footer-widget__column footer-widget__about">
                                ...
                                <ul class="footer-widget__about-contact list-unstyled">
                                    <li>
                                        ...
                                        <div class="text">
                                            <a href="tel:926668880000">+32-(046) 006-8898</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
...
<a href="#" data-target="html" class="scroll-to-target scroll-to-top"><i class="fa fa-angle-up"></i></a>
    ...
    <body>
        ...
        <div class="page-wrapper">
            ...
            @include ('site.components.main-slider')

            @include ('site.components.services')

            @include ('site.components.get-to-know')

            @include('site.components.ready')

            @include ('site.components.why-choose')

            @include ('site.components.work-showcase')

            @include ('site.components.counter-banner')
            ...
            @include ('site.components.contact-2')

            @include ('site.components.brands')

            @include ('site.components.footer-template')
